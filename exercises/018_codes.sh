...
tb "create_transfers id=18000 debit_account_id=1800 credit_account_id=1801 amount=100 ledger=100 code=$WITHDRAWAL;"
...
tb "create_transfers id=18002 debit_account_id=1802 credit_account_id=1800 amount=100 ledger=100 code=$DEPOSIT;"
